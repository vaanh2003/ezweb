<div class="App_sidebarWrap__3LwsB">
    <div class="Sidebar_wrapper__kUJFm" id="sidebar">
        <ul class="Sidebar_list__HnCzM">
            <li><a aria-current="page" class="Sidebar_itemBtn__Q78b7 Sidebar_active__uvck8"
                    href="<?php echo base_url; ?>home"><svg aria-hidden="true" focusable="false" data-prefix="fas"
                        data-icon="house" class="svg-inline--fa fa-house " role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512">
            ...
            <li><a class="Sidebar_itemBtn__Q78b7 " href="<?php echo base_url; ?>khoahoc"><svg aria-hidden="true"
                        focusable="false" data-prefix="fas" data-icon="lightbulb" class="svg-inline--fa fa-lightbulb "
            ...
            <li><a class="Sidebar_itemBtn__Q78b7" href="<?php echo base_url; ?>about"><svg
                        xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-alert-circle-filled"
            ...
            <li><a class="Sidebar_itemBtn__Q78b7" href="<?php echo base_url; ?>blog"><svg aria-hidden="true"
                        focusable="false" data-prefix="fas" data-icon="newspaper" class="svg-inline--fa fa-newspaper "
            ...
            <li><a class="Sidebar_itemBtn__Q78b7" href="<?php echo base_url; ?>contact"><svg
                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                        <path
                            d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z" />
                    </svg><span>Liên Hệ</span></a></li>
            <li><a class="Sidebar_itemBtn__Q78b7" href="<?php echo base_url; ?>tailieu"><svg
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        class="icon icon-tabler icon-tabler-files" viewBox="0 0 24 24" stroke-width="2"
        ...
        <div>
            <div class="ScrollList_heading-wrap__58LQx">
                <h2 class="ScrollList_heading__BYEXH"><a rel="noreferrer" target="_self"
                        href="<?php echo base_url; ?>khoahoc">Khóa học miễn phí</a></h2>
                <a class="ScrollList_view-all__MTYc1" rel="noreferrer" target="_self"
                    href="<?php echo base_url; ?>khoahoc">Xem thêm khoa học<svg aria-hidden="true" focusable="false"
                        data-prefix="fas" data-icon="chevron-right" class="svg-inline--fa fa-chevron-right " role="img"
