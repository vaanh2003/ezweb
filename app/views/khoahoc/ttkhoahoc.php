<div class="App_sidebarWrap__3LwsB">
    <div class="Sidebar_wrapper__kUJFm" id="sidebar">
        <ul class="Sidebar_list__HnCzM">
            <li><a aria-current="page" class="Sidebar_itemBtn__Q78b7" href="<?php echo base_url; ?>home"><svg
                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="house"
                        class="svg-inline--fa fa-house " role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512">
            ...
            <li><a class="Sidebar_itemBtn__Q78b7 Sidebar_active__uvck8" href="<?php echo base_url; ?>khoahoc"><svg
                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="lightbulb"
                        class="svg-inline--fa fa-lightbulb " role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 384 512">
                        <path fill="currentColor"
                ...
                <div class="CourseDetail_purchaseBadge__CZ9PK">
                    <div class="CourseDetail_imgPreview__qGZSi">
                        <div class="CourseDetail_bg__Xacm8"
                            style="background-size: contain, cover; background-image: url(&quot;<?php echo $data[0]['img']; ?>&quot;);"></div>
                    </div>
                    <h5>Miễn phí</h5>
