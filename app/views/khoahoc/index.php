...
<div class="App_withSidebarContent__o4VlQ">
    <div class="mb-4" style="margin: 0 40px;">
        ...
        <div class="MarkdownParser_wrapper__JYN63 DefaultLayout_desc__rr0iE">
            <p>Các khóa học được thiết kế theo thứ tự giúp người mới dễ dàng tiếp cận. Tất cả các khóa học đều miễn phí, chất lượng và nội dung dễ hiểu.</p>
        </div>
    </div>
    <div class="ScrollList_vertical__hG0sb">
        <div>
            <div class="ScrollList_heading-wrap__58LQx">
                <h2 class="ScrollList_heading__BYEXH"><a rel="noreferrer" target="_self" href="<?php echo base_url; ?>khoahoc">Khóa học back end</a></h2>
            </div>
        </div>
        <div class="ScrollList_body__iMN-l">
            <section class="index-module_row__-AHgh">
                ...
                foreach ($data as $key => $value) {
                    if ($value['mo_ta'] == "Back-end") {
                ?>
                        <section class="index-module_col__2EQm9 index-module_c-12__u7UXF index-module_m-4__30Uoi index-module_l-3__MjWvb">
                            <div class="CommonItem_wrapper__1FbHi Home_courseItem__aIeZ4"><a class="CommonItem_thumb__ew8Jj CommonItem_has-link__VLLrX" title="Kiến Thức Nhập Môn IT" target="_self" href="<?php echo $value['id'] ?>" style="background-image: url(&quot;<?php echo $value['img'] ?>&quot;);"></a>
                                <h3 class="CommonItem_title__EpYrE"><a target="_self" href="<?php echo $value['id'] ?>"><?php echo $value['ten'] ?></a></h3>
    ...
    <div class="ScrollList_vertical__hG0sb">
        <div>
            <div class="ScrollList_heading-wrap__58LQx">
                <h2 class="ScrollList_heading__BYEXH"><a rel="noreferrer" target="_self" href="<?php echo base_url; ?>khoahoc">Khóa học font end</a></h2>
            </div>
        </div>
        <div class="ScrollList_body__iMN-l">
            <section class="index-module_row__-AHgh">
