...
<div class="App_sidebarWrap__3LwsB">
        <div class="Sidebar_wrapper__kUJFm" id="sidebar">
            <ul class="Sidebar_list__HnCzM">
                ...
                <li><a class="Sidebar_itemBtn__Q78b7 Sidebar_active__uvck8" href="<?php echo base_url; ?>blog"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="newspaper" class="svg-inline--fa fa-newspaper " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <form method="post">
                        ...
                        <?php
                            ...
                            foreach ($data as $key => $value) {
                                ...
                                <textarea name="message" placeholder="Viết câu hỏi của bạn" value="">'.$value['noi_dung'].'</textarea></br>
                                <input type="hidden" name="iduser" value="'.$value['user_id'].'">
                                <input type="hidden" name="idcauhoi" value="'.$value['id'].'">
                                ';
                            }
