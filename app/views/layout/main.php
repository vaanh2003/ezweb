...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="input-group w-50">
            ...
            <button class="btn bg-white border d-flex align-items-center" type="button" id="button-addon1"><i
        ...
        <nav class="nav">
            <div> <a href="<?php echo base_url; ?>home" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i>
                ...
                <div class="nav_list">
                    ...
                    <a href="<?php echo base_url; ?>khoahoc" class="nav_link"> <i class='bx bx-book-open'></i> <span
                            class="nav_name">Khoá Học</span> </a>
                    <a href="<?php echo base_url; ?>tailieu" class="nav_link"> <i class='bx bx-folder nav_icon'></i>
                        <span class="nav_name">Tài Liệu</span> </a>
                    <a href="<?php echo base_url; ?>blog" class="nav_link"><i
                            class='bx bx-message-square-detail nav_icon'></i><span class="nav_name">Cộng Đồng</span>
                    </a>
                    <a href="<?php echo base_url; ?>contact" class="nav_link"> <i class='bx bx-phone'></i> <span
                            class="nav_name">Liên Hệ</span> </a>
                </div>
    ...
    <footer class="footer">
        <div class="row">
            <div class="col-sm-6 col-md-4 footer-navigation">
                ...
                <p class="links"><a href="<?php echo base_url; ?>home">Home</a><strong> &middot; </strong><a
                        href="<?php echo base_url; ?>khoahoc">Khoá Học</a><strong> &middot; </strong><a
                        href="<?php echo base_url; ?>tailieu">Tài Liệu</a><strong> &middot; </strong><a
                        href="<?php echo base_url; ?>blog">Cộng Đồng</a><strong> &middot; </strong><a
                        href="<?php echo base_url; ?>contact">Liên Hệ</a></p>
            ...
            <div class="col-md-4 footer-about">
                ...
                <div class="social-links social-icons"><a
                        href="https://www.facebook.com/profile.php?id=100093419923442"><i
